...
// first-bed-01-C2-N
translate([100, 1300, 200+1*explode_mm])
  color([0.70,0.52,0.33]) cube([2200, 100, 200]);
// first-bed-01-C2-W
translate([0, 0, 200+1*explode_mm])
  color([0.70,0.52,0.33]) cube([100, 1400, 200]);
// first-bed-01-C2-E
...
if (show_fixing_paths) translate([2400, 1350.0, 250.0+1*explode_mm]) rotate([0,-90,0]) color([0.8,0.1,0.1]) cylinder(d=7, h=150);
if (show_fixing_paths) translate([2400, 1350.0, 350.0+1*explode_mm]) rotate([0,-90,0]) color([0.8,0.1,0.1]) cylinder(d=7, h=150);
...
if (show_fixing_paths) translate([2350.0, 1200.0, 400+1*explode_mm]) rotate([180,0,0]) color([0.8,0.1,0.1]) cylinder(d=7, h=250);
if (show_fixing_paths) translate([300.0, 1350.0, 400+1*explode_mm]) rotate([180,0,0]) color([0.8,0.1,0.1]) cylinder(d=7, h=250);
if (show_fixing_paths) translate([900.0, 1350.0, 400+1*explode_mm]) rotate([180,0,0]) color([0.8,0.1,0.1]) cylinder(d=7, h=250);
if (show_fixing_paths) translate([1500.0, 1350.0, 400+1*explode_mm]) rotate([180,0,0]) color([0.8,0.1,0.1]) cylinder(d=7, h=250);
if (show_fixing_paths) translate([2100.0, 1350.0, 400+1*explode_mm]) rotate([180,0,0]) color([0.8,0.1,0.1]) cylinder(d=7, h=250);
...
if (show_fixing_paths) translate([0, 1350.0, 250.0+1*explode_mm]) rotate([0,90,0]) color([0.8,0.1,0.1]) cylinder(d=7, h=150);
if (show_fixing_paths) translate([0, 1350.0, 350.0+1*explode_mm]) rotate([0,90,0]) color([0.8,0.1,0.1]) cylinder(d=7, h=150);
...
if (show_fixing_paths) translate([50.0, 1200.0, 400+1*explode_mm]) rotate([180,0,0]) color([0.8,0.1,0.1]) cylinder(d=7, h=250);
...
if (show_fixing_paths) translate([2220.0, 1350.0, 600+2*explode_mm]) rotate([180,0,0]) color([0.8,0.1,0.1]) cylinder(d=7, h=250);
