# Reviewed workshop build - 2 courses, 2400x1200 mm


**REVIEWED_WORKSHOP_PLAN** | 2026-09-06 | plan `6ebfa2b9d9d2dd15ed4f245bb289d9565943b2f565ab21774eafcfd53e4c4137`
...
| front-01 | 2400 x 1200 x 400 | 2 | 2200 x 1000 | 770.0 | 2683.3 |


## Purchase / cutting summary

6 purchased sleepers; 0 existing stock pieces used; 6 full crosscuts. Optimiser: **exact**. All explored cutting patterns and inventory states solved.

Finished timber: 13600 mm. Input stock: 14400 mm. Remaining offcuts: 782 mm. Kerf + trim loss: 18 mm.

Offcuts are not all waste. No speculative offcut resale credit is used to reduce today's purchase cost.

Timber and screw purchases: **GBP 189.30**. Known subtotal: **GBP 463.30**.

Complete job cost: GBP 463.30. Unpriced: none.

Internal margin-based target: GBP 617.74. Margin target is suppressed until all required costs are supplied. Zero is an explicit decision that an item is not needed/already allowed, not a missing price.
